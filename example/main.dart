          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Wrap(
                ...
                children: [
                  ...
                  Chip(
                    ...
                    deleteIcon: _useGroupingList ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _singleSelection ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _useTextForFiltering ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _useFooter ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _useTitle ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                        _useTitle = !_useTitle;
                      });
                  ...
                  Chip(
                    ...
                    deleteIcon: _defaultData ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _customMultiselectWidget ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
                  ...
                  Chip(
                    ...
                    deleteIcon: _customSingleSelectWidget ? const Icon(Icons.check_box) : const Icon(Icons.check_box_outline_blank),
                    onDeleted: (){
                      setState(() {
              ...
              MultiSelectField<Car>(
                title: _useTitle ? (val) => const Text('Optional Title Widget',) : null,
                defaultData:()=> _defaultData ? [picks.first] : [],
                decoration: BoxDecoration(
                    color: Colors.black12,
                    borderRadius: BorderRadius.circular(12)
                ),
                footer: _useFooter ? const Text('Optional Footer Widget') : null,
                data: () => _useGroupingList ? picks : picks.where((e) => e.key.isNotEmpty).toList(),
                onSelect: (element){

                  setState(() {
                    currentCar = element.isNotEmpty ? element.first.metadata : null;
                  });
                },
                singleSelection: _singleSelection,
                useTextFilter: _useTextForFiltering,
                multiSelectWidget: _customMultiselectWidget ? (pick){
                        ...
                        return AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              ...
                              Text("sold: ${pick.metadata?.totalSold}"),
                            ],
                          ),
                          actions: [
                            OutlinedButton(
                ...
                singleSelectWidget: _customSingleSelectWidget? (pick){
                  return Chip(
              ...
              const SizedBox(height: 20,),
              Text("Additional properties", style: Theme.of(context).textTheme.titleLarge,),
              ListTile(
                title: Text("textStyleSingleSelection", style: Theme.of(context).textTheme.titleMedium,),
                subtitle: const Text("Help to create your own style for single selection using the standard widget. For more flexibility, use singleSelectWidget(pick){}."),
              ),

              ListTile(
                title: Text("padding", style: Theme.of(context).textTheme.titleMedium,),
