...
void main() {
  ...
  group('Standard - Single selection', () {
    testWidgets('selects one item and replaces on new selection', (
      tester,
    ) async {
    ...
    testWidgets('deselects current item when tapped again (non-mandatory)', (
      tester,
    ) async {
      final selected = <List<String>>[];
      await tester.pumpWidget(
  ...
  group('Standard - isMandatory', () {
    testWidgets('single selection: cannot deselect when mandatory', (
      tester,
    ) async {
      final selected = <List<String>>[];
      await tester.pumpWidget(
    ...
    testWidgets('multi selection: can deselect when more than one item', (
      tester,
    ) async {
      final selected = <List<String>>[];
      await tester.pumpWidget(
  ...
  group('Standard - Label behavior', () {
    ...
    testWidgets('staticLabel always shows label even with selection', (
      tester,
    ) async {
      await tester.pumpWidget(
        wrap(
  ...
  group('Standard - Callbacks', () {
    testWidgets('onSelect fires with isFromDefault=false on user action', (
      tester,
    ) async {
      bool? wasDefault;
      await tester.pumpWidget(
  ...
  group('Standard - Keyboard interactions', () {
    testWidgets('enter key selects matching item from text input', (
      tester,
    ) async {
      final selected = <List<String>>[];
      await tester.pumpWidget(
      ...
      await tester.pumpWidget(
        wrap(
          MultiSelectField<String>(
            ...
            decoration: decoration,
            defaultData: [Choice<String>('1', 'Option 1')],
            iconLeft: (isOpen, choice) =>
                Icon(Icons.filter_list, key: const Key('custom-icon-left')),
          ),
        ),
      );
  ...
  group('Standard - Visual indicators', () {
    testWidgets('check icon shows for selected items (no selectAll)', (
      tester,
    ) async {
      await tester.pumpWidget(
        wrap(
  ...
  group('Standard - closeOnSelect', () {
    ...
    testWidgets('menu closes after selection when closeOnSelect=true', (
      tester,
    ) async {
      await tester.pumpWidget(
        wrap(
    ...
    testWidgets('onChanged still fires when closeOnSelect=true', (
      tester,
    ) async {
      final changed = <int>[];
      await tester.pumpWidget(
